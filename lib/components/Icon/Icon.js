...
const VALID_ICON_SIZES = ['x-small', 'small', 'medium', 'large'];

const VALID_TEXT_COLORS = ['default', 'warning', 'error'];
...
const propTypes = {
   ...
   */
  size: PropTypes.oneOf(VALID_ICON_SIZES),
  /**
   ...
   */
  textColor: PropTypes.oneOf(VALID_TEXT_COLORS),
};
...
class Icon extends Component {
  ...
  renderSVG({
    ...
    const iconColor = getIconColor(fillColor, category, icon);
...
Icon.icons = VALID_ICONS;
Icon.propTypes = propTypes;
Icon.defaultProps = defaultProps;
Icon.validCategories = VALID_CATEGORIES;
Icon.validIconSizes = VALID_ICON_SIZES;
Icon.validTextColors = VALID_TEXT_COLORS;
